...
const wayneList1 = ["oceanrestaurant.netlify.app", "delightful-smakager-b5ed06.netlify.app", "imaginative-flan-4a888f.netlify.app", "goldenflower.onrender.com", "matsucafe.onrender.com"];
const wayneList2 = [];
const wayneList3 = [];
const wayneList4 = [];
const wayneList5 = [];
