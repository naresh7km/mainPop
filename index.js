...
const fourthList = ["hdjavforyou", "javhdaffiliates", "hikokimagic", "osakastreetbites", "shoppiejapanclothes", "fitzonefitness"];
const fifthList = ["sakuracoffee", "yumimasseuse", "mahbubanioldage"];
