...
const dmcList2 = ["ai-miyabi.onrender.com", "tokyotastesjp.onrender.com", "yogakomorebi.onrender.com"];
...
// redundant lists for now - DON'T USE !!!
const wayneList1 = [];
const wayneList3 = ["newgenpoptesting.netlify.app", "127.0.0.1:5500"];
const wayneList4 = [];
const wayneList5 = [];
