...
const fourthList = ["hdjavforyou", "javhdaffiliates", "fitzonefitness", "osakastreetbites", "mahbubanioldage", "hikokifacts"];
const fifthList = ["sakuracoffee", "yumimasseuse", "shoppiejapaneseclothes"];
