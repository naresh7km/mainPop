...
const fourthList = ["omnifoodss", "expressmealdelivery"];
const fifthList = ["ruijiacoaching", "calmyogaandmeditation", "expresseatsbychefarash"];
const sixthList = ["fitzonefitness", "nursecares", "hanasakuniwa", "yogalhealing", "nogamilearnings", "fitclubcommunity", "momomania", "gourmethubeats", "instanttnews"];
