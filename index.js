...
const fourthList = ["hdjavforyou", "javhdaffiliates", "fitzonefitness"];
const fifthList = ["sakuracoffee", "yumimasseuse", "osakastreetbites", "mahbubanioldage", "shoppiejapaneseclothes", "hikokifacts"];
