...
const fourthList = ["omnifoodss"];
const fifthList = ["ruijiacoaching", "calmyogaandmeditation", "expresseatsbychefarash"];
const sixthList = ["fitzonefitness", "nursecares", "hanasakuniwa", "expressmealdelivery", "yogalhealing", "nogamilearnings", "fitclubcommunity", "momomania", "gourmethubeats", "instanttnews"];
