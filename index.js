...
const secondList = ["hdjavforyou", "hotelroyaltonjp", "javhdaffiliates"];
const thirdList = ["spadelightjapan", "seishinyogajp", "foodhutjapan", "yuyado-onsen"];
const fourthList = ["shoppiejapanclothes"];
const fifthList = ["osakastreetbites"];
