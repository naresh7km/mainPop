...
const secondList = ["spa-delightjp", "yogametic", "shoppiejapanclothes", "osakastreetbites"];
const thirdList = ["seishinyogajp", "komorebiyoga", "tatsumionsen"];
const fourthList = ["hdjavforyou", "javhdaffiliates"];
const fifthList = ["hanamionsen", "wash-o-kuan", "hoshianimeinfo", "yogalex", "fitzonefitness", "shinkansen", "sakuracoffee", "hikokimagic", "yumimasseuse"];
