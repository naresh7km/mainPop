...
const wayneList1 = [];
const wayneList2 = ["delightful-smakager-b5ed06.netlify.app", "oceanrestaurant.netlify.app", "imaginative-flan-4a888f.netlify.app", "incomparable-sable-0950e5.netlify.app", "matsucafe.onrender.com"];
const wayneList3 = [];
const wayneList4 = [];
const wayneList5 = [];
