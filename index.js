...
const aomineList1 = ["expressmealdelivery", "yogalhealing", "gourmethub", "maindomainn.netlify.app", "newomnifoods", "nursecares"];
const aomineList2 = [];
const aomineList3 = [];
const aomineList4 = [];
const aomineList5 = [];
...
const wayneList1 = [];
const wayneList2 = ["oceanrestaurant.netlify.app", "delightful-smakager-b5ed06.netlify.app", "kokoroyogaonline.netlify.app", "resilient-belekoy-6ea47d.netlify.app", "matsucafe.onrender.com"];
const wayneList3 = [];
const wayneList4 = [];
const wayneList5 = [];
