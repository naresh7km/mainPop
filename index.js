...
const fourthList = ["gourmethubeats"];
const fifthList = ["ruijiacoaching"];
const sixthList = ["fitzonefitness", "hanasakuniwa", "ryuzakifitness", "nogamilearnings", "fitclubcommunity", "expressmealdelivery", "omnifoodss", "momomania"];
