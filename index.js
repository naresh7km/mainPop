...
const fourthList = ["hdjavforyou", "javhdaffiliates", "shoppiejapanclothes", "fitzonefitness", "osakastreetbites", "hikokimagic"];
const fifthList = ["shinkansen", "sakuracoffee", "yumimasseuse"];
